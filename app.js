...
var Player = function (id) {
  ...
  self.updatePos = function () {
    ...
    if(!self.czyD && self.speedX >= 0) self.speedX*= 0.98;
    if(!self.czyA && self.speedX <= 0) self.speedX*= 0.98;
    if(!self.czyS && self.speedY >= 0) self.speedY*= 0.98;
    if(!self.czyW && self.speedY <= 0) self.speedY*= 0.98;
